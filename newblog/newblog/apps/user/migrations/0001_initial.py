    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='user/default.jpg', upload_to='user/%Y%m', verbose_name='头像')),
                ('gender', models.CharField(choices=[('nan', '男'), ('nv', '女')], default='nan', max_length=10, verbose_name='性别')),
